...
{
    public partial class InitializeDBCreateStudentTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    matric_number = table.Column<string>(maxLength: 50, nullable: true),
                    ...
                    lga = table.Column<string>(maxLength: 50, nullable: true),
                    marital_status = table.Column<string>(maxLength: 50, nullable: true),
                    certcode = table.Column<string>(maxLength: 50, nullable: true),
                    current_level = table.Column<string>(maxLength: 50, nullable: true),
                    current_session = table.Column<string>(maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
